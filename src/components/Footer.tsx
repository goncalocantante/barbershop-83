      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row justify-between items-center">
          <div class="mb-4 md:mb-0">
            <span class="text-2xl font-serif font-bold text-white">BARBER<span class="text-primary">83</span></span>
          </div>
          ...
          <div class="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Barber 83. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
