      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 pt-20">
        <div class="text-center">
          <h1 class="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl font-serif">
            <span class="block">BARBERSHOP 83</span>
            <span class="block text-primary mt-2">ALCÂNTARA</span>
          </h1>
          <p class="mt-3 max-w-md mx-auto text-base text-gray-300 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Experience the art of traditional barbering by Pedro Pereira Felizardo. 
            Precision cuts and classic shaves in a premium atmosphere.
          </p>
